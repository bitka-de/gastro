            ...
            <div class="w-full flex items-center gap-x-1.5">
                <ul class="flex items-center gap-1.5">
                    ...
                    <li
                        ...
                        <div class="hidden sm:block ms-1"></div>
                    </li>
                            ...
                            <div
                                ...
                                <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-60 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white border border-gray-200 rounded-xl shadow-xl"
                                    ...
                                    <div class="p-1 border-t border-gray-200">
                                        <a href="{{ route('users.index') }}" class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-600 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-100">
...
<div class="py-3 px-4 flex flex-wrap justify-between items-center gap-2 bg-white border-b border-gray-200">
        <div>
    ...
    <div class="flex-1 flex flex-col overflow-y-auto [&::-webkit-scrollbar]:w-0">
      <div class="flex-1 flex flex-col lg:flex-row">
        <div class="flex-1 min-w-0 flex flex-col border-e p-4 border-gray-200">
           @yield('content')
        </div>
        <!-- End Col -->
